...
public class GameFileDataMapperTests {
    ...
    public void setUp() throws GameNotFoundException {
        mapper = new GamesFileDataMapper("./src/main/java/com/company/cource/homeworks/homework14_mapper/newGameStore.txt");
    }
    ...
    @Test
    void exceptionTesting() throws GameNotFoundException {

        GameNotFoundException thrown =
                assertThrows(GameNotFoundException.class,
                        () -> new GamesFileDataMapper("some/path"),
                        "The system cannot find the file");

        assertTrue(thrown.getMessage().contains("The system cannot find the file"));
    }
}
